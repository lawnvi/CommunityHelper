...
public class Global {
    //goods status
    public static final String GOODS_STATUS_ON_SALE = "on_sale";
    public static final String GOODS_STATUS_SOLD = "sold";
    public static final String GOODS_STATUS_LOCK = "lock";
    public static final String GOODS_STATUS_HIDING = "hiding";
